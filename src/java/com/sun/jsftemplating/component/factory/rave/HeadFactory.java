...
/**
 *  <p>	This factory is responsible for instantiating a <code>Head
 *	UIComponent</code>.</p>
 *
 *  <p>	The id for this component is: "rave:head".</p>
 *
 *  @author Ken Paulsen	(ken.paulsen@sun.com)
 */
@UIComponentFactory("rave:head")
public class HeadFactory extends ComponentFactoryBase {
     ...
     */
    public static final String COMPONENT_TYPE	= "com.sun.rave.web.ui.Head";
}
