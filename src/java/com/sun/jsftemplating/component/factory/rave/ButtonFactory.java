...
/**
 *  <p>	This factory is responsible for instantiating a <code>Button
 *	UIComponent</code>.</p>
 *
 *  <p>	The id for this component is: "rave:button".</p>
 *
 *  @author Ken Paulsen	(ken.paulsen@sun.com)
 */
@UIComponentFactory("rave:button")
public class ButtonFactory extends ComponentFactoryBase {
	...
	comp.getAttributes().put("primary", Boolean.TRUE);
     ...
     */
    public static final String COMPONENT_TYPE	= "com.sun.rave.web.ui.Button";
}
