 ...
 *	UIComponent</code>.</p>
 *
 *  <p>	The id for this component is: "rave:tableColumn".</p>
 *
 *  @author Ken Paulsen	(ken.paulsen@sun.com)
 */
@UIComponentFactory("rave:tableColumn")
public class TableColumnFactory extends ComponentFactoryBase {
     ...
     */
    public static final String COMPONENT_TYPE	= "com.sun.rave.web.ui.TableColumn";
}
