...
/**
 *  <p>	This class evaluates a Boolean equation.  The supported functions /
 *	operators are:</p>
 *
 ...
 *
 *
 *  <p>	Operator Precedence (for infix notation) is:</p>
 *
 *  <ul><li> () -- Highest </li>
 *	<li> ! </li>
 *	<li> % </li>
...
public class PermissionChecker {
    ...
    /**
     *	<p> This method returns the precedence of the given operator.  This
     *	    only applies to infix notation (of course) and is needed to
     *	    correctly order the operators when converting to postfix.</p>
     *
     *	<ul><li> ! (not) has the highest precedence</li>
     *	    <li> % (modulus)</li>
     *	    <li> &amp; (and)</li>
     *	    <li> | (or)</li>
     ...
     *	    </ul>
     *
     *	<p> Of course '(' and ')' can be used to override the order of
     *	    operations in infix notation.</p>
     *
    ...
    /**
     *	<p> This method replaces all "true" / "false" strings w/ 't'/'f'.  It
     ...
     *	    and a StringFunction is added to the function list.</p>
     */
    ...
    /**
     *	<p> This method searches for "$...{...}" in given string and replaces
     *	    them with FUNCTION_MARKER's.  It adds a Function to the
     *	    _tmpFunctionStack for each of these so that it can be inserted in
     *	    the proper place during preProcessing.  If the "${}" evaluates to
     *	    (null), it is replaced with false (BooleanFunction); if it evalutes
     *	    to "false", it also will use a false BooleanFunction.  In all other
     *	    cases, it will be replaced with a StringFunction which evaluates t
     *	    true.</p>
...
// FIXME: simplify this.
     ...
     *	    registered prior to invoking this method.</p>
     */
    ...
    /**
     *	<p> This method returns true if the given character is a valid
     *	    operator.</p>
     */
...
//	    case ARGUMENT_SEPARATOR:
    ...
    /**
     *	<p> This method calculates the postfix representation of the infix
...
//System.out.println("DEBUG: Postfix String: '"+new String(postfixStr)+"'");
    ...
    /**
     *	<p> This method is invoked to determine if the equation evaluates to
     *	    true or false.</p>
     */
    ...
    /**
     *	<p> This method returns the infix representation of the equation, in
     *	    other words: the original String passed in.</p>
     */
    ...
    /**
     *	<p> This method sets the equation and forces a re-evaluation of the
    ...
    /**
     *	<p> Getter for the post fix array.  If it is currently null, an empty
     *	    <code>char[]</code> array will be returned.</p>
     */
    ...
    /**
     *	<p> Setter for the postfix array of chars.</p>
     */
    ...
    /**
     *	<p> This method provides access to a <code>String</code> representation
     *	    of the postfix equation held by this <code>Object</code>.</p>
     */
    ...
    /**
     *	<p> Displays the infix and postfix version of the equation.</p>
     */
    ...
    /**
     *	<p> This toString(...) method generates just the postfix
     ...
     *	    functions put back into the equation.</p>
     *
    ...
    /**
     *	<p> This method removes all whitespace from the given String.</p>
     */
    ...
    /**
     *	<p> This class must be implemented by all user defined Functions.</p>
     *
	 ...
	 *	function to true or false.</p>
	 */
	public boolean evaluate();
    }

    /**
     *	<p> <code>StringFunction</code> implements <code>Function</code> and
     ...
     *	    Otherwise it will return true.  This <code>Function</code> ignores
     *	    all arguments (arguments only apply if it is registered, which
     *	    shouldn't be the case anyway).</p>
     */
	...
	/**
	 *  <p> Determine if the value of the <code>Function</code> is
	...
	/**
	 *  <p>	This methis uses the {@link VariableResolver} to evaluate the
	...
	/**
	 *  <p>	This implementation of <code>toString()</code> returns the
	 *	evaluated value, except when the value is <code>(null)</code>
    ...
    /**
     *	<p> <code>BooleanFunction</code> is either <code>true</code> or
     *	    <code>false</code>.  It is used internally by
     *	    <code>PermissionChecker</code> and is not needed outside
     *	    <code>PermissionChecker</code> since the Strings "true" or "false"
     *	    used in an equation are sufficient.</p>
     */
    protected static class BooleanFunction implements PermissionChecker.Function {

	/**
	 *  <p>	Constructor (defaults to false).</p>
	 */
	...
	/**
	 *  <p> Return the value of the <code>Function</code>;
	 *	<code>true</code> or <code>false</code>.</p>
	 */
	public boolean evaluate() {
	    return _value;
	...
	/**
	 *  <p>	This implementation prints the <code>String</code> "true" or
	 *	"false" based on the stored value.</p>
	 */
	public String toString() {
    ...
    /**
     *	<p> This is here to provide some test cases.  It only tests the
     *	    conversion to postfix notation.</p>
     */
    ...
    /**
     *	<p> This variable represents a "false" BooleanFunction.</p>
     */
    public static final BooleanFunction	FALSE_BOOLEAN_FUNCTION =
	new BooleanFunction(false);

    /**
     *	<p> This variable represents a "true" BooleanFunction.</p>
     */
